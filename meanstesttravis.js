...
//keep for now, toss when five counties done
    ...
    if (annualIncome > medianIncomeTravis[sizeOfHousehold]) {
        ...
        htmlString = '<span>Your gross annual income of </span>' + annualIncome +
            '<span>, based on the average monthly income you entered, is greater than the Travis County median income for a family of </span>' + sizeOfHousehold +
        ...
        htmlString = '<span>Your gross annual income of </span>' + annualIncome +
            '<span>, based on the average monthly income you entered, is at or below than the Travis County median income for a family of </span>' + sizeOfHousehold + '<span>. You are likely qualified for a Chapter 7 filing based on your income level. Please make an appointment with us so we can walk you through a more detailed means test and confirm your eligibility.</span>'
    }
